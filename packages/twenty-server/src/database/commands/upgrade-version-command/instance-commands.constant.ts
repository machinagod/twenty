...
import { CreatePgMessageQueueTablesFastInstanceCommand } from 'src/database/commands/upgrade-version-command/2-9/2-9-instance-command-fast-1799000040000-create-pg-message-queue-tables';
...
export const INSTANCE_COMMANDS = [
  ...
  CreatePgMessageQueueTablesFastInstanceCommand,
];
