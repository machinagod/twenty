import { i as f } from "./isDefined-BAmzg2fZ.mjs";
import t from "lodash.camelcase";
import { slugify as c } from "transliteration";
const g = (e, a) => a.nameSingular === "company" && e.name === "domainName" ? !0 : a.imageIdentifierFieldMetadataId === e.id, s = "name", m = (e, a) => f(a.labelIdentifierFieldMetadataId) ? e.id === a.labelIdentifierFieldMetadataId : e.name === s, w = {
...
var u = /* @__PURE__ */ ((e) => (e.BUILDER_INTERNAL_SERVER_ERROR = "BUILDER_INTERNAL_SERVER_ERROR", e.RUNNER_INTERNAL_SERVER_ERROR = "RUNNER_INTERNAL_SERVER_ERROR", e))(u || {});
const I = (e) => e && (l.includes(e) ? `${e}Custom` : e), n = ({
  label: e,
  applyCustomSuffix: a = !0
}) => {
  if (!e) return "";
  const d = /^\d/.test(e) ? `n${e}` : e;
  if (d === "") return "";
  const r = c(d, {
    trim: !0,
    separator: "_",
  ...
  return i !== "" && i === r && (i = (i + "s").slice(0, b)), { nameSingular: r, namePlural: i };
};
export {
  w as ALL_METADATA_NAME,
  s as DEFAULT_LABEL_IDENTIFIER_FIELD_NAME,
  A as DEFAULT_RELATIONS_OBJECTS_STANDARD_IDS,
  b as IDENTIFIER_MAX_CHAR_LENGTH,
  l as RESERVED_METADATA_NAME_KEYWORDS,
  y as STANDARD_OBJECTS,
  h as STANDARD_PAGE_LAYOUT_UNIVERSAL_IDENTIFIERS,
  u as WorkspaceMigrationV2ExceptionCode,
  I as addCustomSuffixIfIsReserved,
  g as checkIfFieldIsImageIdentifier,
  m as checkIfFieldIsLabelIdentifier,
  n as computeMetadataNameFromLabel,
  k as computeMetadataNamesFromLabelsOrThrow
};
