...
export type LeafFilter = UUIDFilter | StringFilter | FloatFilter | DateFilter | DateTimeFilter | CurrencyFilter | URLFilter | FullNameFilter | BooleanFilter | AddressFilter | LinksFilter | ActorFilter | PhonesFilter | ArrayFilter | RawJsonFilter | FilesFilter | RichTextFilter | TSVectorFilter | undefined;
...
export type RecordGqlOperationFilter = LeafObjectRecordFilter | AndObjectRecordFilter | OrObjectRecordFilter | NotObjectRecordFilter;
//# sourceMappingURL=RecordGqlOperationFilter.d.ts.map