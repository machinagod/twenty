...
export type OrderByWithGroupBy = Array<ObjectRecordOrderByForScalarField | ObjectRecordOrderByForCompositeField | ObjectRecordOrderByWithGroupByDateField | ObjectRecordOrderByForRelationField | AggregateOrderByWithGroupByField>;
...
export type ObjectRecordOrderByForRelationField = {
    [Property in keyof ObjectRecord]?: ObjectRecordOrderByForCompositeField | ObjectRecordOrderByWithGroupByDateField | ObjectRecordOrderByForScalarField;
};
//# sourceMappingURL=ObjectRecordGroupBy.d.ts.map