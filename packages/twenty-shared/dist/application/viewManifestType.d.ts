...
import { type AggregateOperations, type ViewCalendarLayout, type ViewFilterGroupLogicalOperator, type ViewFilterOperand, type ViewKey, type ViewOpenRecordIn, type ViewSortDirection, type ViewType, type ViewVisibility } from '@/types';
export type ViewManifestFilterValue = string | string[] | boolean | number | Record<string, unknown>;
...
//# sourceMappingURL=viewManifestType.d.ts.map